...
import 'package:lapinoz/earining/roundbarchar.dart';
import 'package:lapinoz/overview/bar%20chart%20.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Text('InnerDrawer Example'),
        leading: IconButton(
      ...
      body: InnerDrawer(
        ...
        offset: IDOffset.only(bottom: 0.0, right: 0.5), 
